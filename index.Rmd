...
* Blocking (z = -4.182, pr(>|z|) < 0.001), Identity (z = 8.951, pr(>|z|) < 0.001) and dialectual background (z = 16.760, pr(>|z|) < 0.001) all have main effects on the final rating scores.
